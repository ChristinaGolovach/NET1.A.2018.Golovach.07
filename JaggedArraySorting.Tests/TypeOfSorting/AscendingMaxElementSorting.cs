...
{
    /// <summary>
    /// Class describes comparer for two arrays in ascending order by max element in them.
    /// </summary>
    public class AscendingMaxElementSorting : IComparer<int[]>
    {
        /// <summary>
        /// Extension method compares two integer array in ascending order by max element in them. 
        /// </summary>
